-- [MANTÉM TODO SEU CÓDIGO ORIGINAL ABAIXO, APENAS RENOMEIA E AJUSTA VISUAL]
...
local function teleportToEmptyServer()
    ...
    -- Remove tudo da tela antes de exibir o fullscreen

    local player = game.Players.LocalPlayer

    local playerGui = player:FindFirstChildOfClass("PlayerGui")

    -- Remove todos os ScreenGuis (exceto CoreGui)
    ...
    -- Cria tela preta fullscreen

    if playerGui and not playerGui:FindFirstChild("HyperHubPvChangeScreen") then

        local ScreenGui = Instance.new("ScreenGui")

        ScreenGui.Name = "HyperHubPvChangeScreen"
        ...
        MainText.Text = "TROCANDO DE SERVIDOR"
        ...
        MainText.Size = UDim2.new(1, 0, 0.12, 0)

        MainText.Position = UDim2.new(0, 0, 0.44, 0)
...
if playerGui:FindFirstChild("HyperHubPvMain") then

    playerGui:FindFirstChild("HyperHubPvMain"):Destroy()

end

-- TELA PRINCIPAL PRETA E CENTRALIZADA

local ScreenGui = Instance.new("ScreenGui")

ScreenGui.Name = "HyperHubPvMain"
...
TitleLabel.Size = UDim2.new(1, -10, 0, 34)
...
TeleportButton.Text = "Teleportar para servidor vazio"
...
TeleportButton.TextStrokeTransparency = 0.4

TeleportButton.Size = UDim2.new(1, -20, 0, 40)

TeleportButton.Position = UDim2.new(0, 10, 0, 60)

TeleportButton.BackgroundColor3 = Color3.new(0.1, 0.1, 0.1)
...
-- Drag funcionalidade igual original
